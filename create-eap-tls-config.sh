...
#chmod +x create-eap-tls-config.sh
#execute with: ./create-eap-tls-config.sh

clear
read -p "SSID Name: " ssidName
read -ep "P12 cert to import: " p12CertPath
...
clientCertPath="/etc/wpa_supplicant/certs/user.crt.pem"
...
cat > /etc/wpa_supplicant/wpa_supplicant.config <<- EOM
